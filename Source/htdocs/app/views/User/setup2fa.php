...
<div class="content">
    <h1><?= _("Setup 2-Factor Authentication") ?></h1>

    <form class="user-form" method="post">
        <img src="http://localhost/User/makeQrCode?data=<?= $data ?>" /> 

        <div>
            <?= _("Please scan the QR-code on the screen with your favorite Authenticator software, such as Google Authenticator. The 
        ...
        <button class="orange-button" style="margin-bottom: 0;" type="submit" name="submit"><?= _("Setup") ?></button>
    </form>
